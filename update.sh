...
DEST=/chronokeep/certificates/
SERVICE_NAME=chronokeep-certificates
REPO_URL='https://api.github.com/repos/grecaun/chronokeep-certificates/releases/latest'
UPDATE_SCRIPT_URL='https://raw.githubusercontent.com/grecaun/chronokeep-certificates/main/update.sh'

VERSION=1

echo "------------------------------------------------"
echo "--------- Now updating Certificates! -----------"
echo "------------------------------------------------"
...
echo "- Checking latest Certificates release version -"
echo "------------------------------------------------"
...
echo Latest Certificates version is ${LATEST_VERSION}
echo "------------------------------------------------"
echo Current Certificates version is ${CURRENT_VERSION}
echo "------------------------------------------------"
...
if [[ ${LATEST_VERSION_MAJOR} -gt ${CURRENT_VERSION_MAJOR} ]] ||
        ...
        echo "- New version found! Updating Certificates now -"
        echo "------------------------------------------------"
        ...
        echo "--------- Certificates update complete ---------"
        echo "------------------------------------------------"
else
        echo "------- Certificates already up to date --------"
        echo "------------------------------------------------"
fi
